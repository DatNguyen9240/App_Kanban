      ...
      >
        <div className="px-5 py-3.5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-slate-800">Create New Project</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-semibold text-slate-600 mb-1">Project Key *</label>
              <input
                type="text"
                required
                maxLength={6}
                ...
                className="w-full text-xs text-slate-800 px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-indigo-500 uppercase font-mono"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full text-xs text-slate-800 p-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-indigo-500 resize-none"
            />
          </div>
